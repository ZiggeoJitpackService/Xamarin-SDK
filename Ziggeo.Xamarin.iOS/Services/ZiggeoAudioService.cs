...
namespace Ziggeo.Xamarin.iOS.Services
{
    public class ZiggeoAudioService : IAudios
    {
        ...
        private ZiggeoAudios Audios { get; }

        public ZiggeoAudioService(ZiggeoMediaSDK.Ziggeo ziggeo)
        {
        ...
        public async Task<JArray> Index(Dictionary<string, string> data)
        {
            ...
            Audios.Index(dictionary, (jsonArray, error) =>
            {
                if (error == null)
                {
        ...
        public async Task Destroy(string tokenOrKey)
        {
            ...
            Audios.Destroy(tokenOrKey, (jsonObject, response, error) =>
            {
                if (error == null)
                {
                    var result = "";
        ...
        public async Task<JObject> Create(string filePath, Dictionary<string, string> data)
        {
            ...
            Audios.Create(filePath, dictionary, (jsonObject, response, error) =>
            {
            },
